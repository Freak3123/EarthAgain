...
export default function BlogPage() {
  ...
  const articles = [
    {
      id: 1,
      title: "The Science Behind Climate Change in Odisha: What Every Citizen Should Know",
      excerpt:
    ...
    {
      id: 3,
      title: "Youth Leadership in Climate Action: Empowering the Next Generation",
      excerpt:
    ...
    {
      id: 4,
      title: "Sustainable Agriculture Practices: A Farmer's Guide to Climate Resilience",
      excerpt:
    ...
    {
      id: 5,
      title: "The Role of Traditional Knowledge in Modern Environmental Conservation",
      excerpt:
    ...
    {
      id: 6,
      title: "Renewable Energy Revolution: Solar Power Opportunities in Rural Odisha",
      excerpt:
  ...
  const filteredArticles = articles.filter((article) => {
    ...
    const matchesCategory =
      !filterCategory || filterCategory === "All Categories" || article.category === filterCategory
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-4 md:px-6 lg:px-8 bg-gradient-to-b from-green-50 to-white">
        <div className="max-w-7xl mx-auto text-center">
          <Badge className="bg-green-100 text-green-800 hover:bg-green-200 mb-6">Earth Again Blog</Badge>
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Stories of <span className="text-green-600">Change</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-12">
            Discover insights, success stories, and expert knowledge about sustainability, climate action, and
            environmental conservation in Odisha and beyond.
          </p>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <Select onValueChange={setFilterCategory} defaultValue="All Categories">
                <SelectTrigger>
            ...
            <Card className="border-0 shadow-2xl overflow-hidden">
              <div className="grid lg:grid-cols-2">
                ...
                <CardContent className="p-8 lg:p-12">
                  ...
                  <p className="text-lg text-gray-600 mb-8">{featuredArticle.excerpt}</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-xl text-gray-600">{filteredArticles.length} articles found</p>
            </div>
      ...
      <section className="py-20 px-4 md:px-6 lg:px-8 bg-green-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Subscribe to our newsletter and never miss the latest insights, stories, and updates from the Earth Again
            movement.
          </p>
